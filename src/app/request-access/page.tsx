          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="rounded-lg bg-gray-50 border border-gray-200 p-4 space-y-3">
              <p className="text-xs text-gray-600 leading-relaxed">
                ...
                including improving our AI features. You retain ownership of your business data. You&rsquo;re responsible for
                having the right to enter any client/customer information you input. We don&rsquo;t sell your data to third
                parties.
              </p>
